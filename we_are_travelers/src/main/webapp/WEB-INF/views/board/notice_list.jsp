		...
		<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<c:if test="${scri.board_code=='n_culture'}">
					...
					<c:if test="${scri.board_code=='n_activity'}">
					...
					<c:if test="${scri.board_code=='n_fishing'}">
					...
					<c:if test="${scri.board_code=='n_camping'}">
					...
					<c:if test="${scri.board_code=='n_lodgment'}">
