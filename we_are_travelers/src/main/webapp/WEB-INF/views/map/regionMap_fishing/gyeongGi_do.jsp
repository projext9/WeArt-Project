...
<body>
	<div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" style="margin-left: 125px; margin-right: 125px;">
		...
		<div class="carousel-inner" style="border-radius: 30px;">
			<div class="carousel-item">
				...
				<img src="${pageContext.request.contextPath}/resources/img/Map_image/fishing/fishing1.jpg" class="img-fluid" alt="이미지가없습니다.">
				<div class="container">
			...
			<div class="carousel-item">
				<svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false">
					<rect width="100%" height="100%" fill="#777"></rect></svg>
				<img src="${pageContext.request.contextPath}/resources/img/Map_image/fishing/fishing2.jpg" class="img-fluid" alt="이미지가없습니다.">
				<div class="container">
			...
			<div class="carousel-item active">
				<svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false">
					<rect width="100%" height="100%" fill="#777"></rect></svg>
				<img src="${pageContext.request.contextPath}/resources/img/Map_image/fishing/fishing3.jpg" class="img-fluid" alt="이미지가없습니다.">
				<div class="container">
  ...
  <path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146zM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5z" />
	...
	<div class="btn-group" role="group" style="float: right">
		...
		<li value="All"><a class="dropdown-item" href="${pageContext.request.contextPath}/fishingList.do">전체리스트</a></li>
