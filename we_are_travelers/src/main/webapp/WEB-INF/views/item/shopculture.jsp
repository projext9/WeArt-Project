				      	...
				      	<img class="bd-placeholder-img" style="width:100vw; height:300px;" src="${pageContext.request.contextPath}/resources/img/fishingshop/fishing2.png" aria-hidden="true"></img>
					        <div class="container">
								<div class="carousel-caption text-start">
									<h1 style="text-shadow:5px 5px 5px #000;">이것은 문화상품</h1>
						            <p>우수한 품질의 중국산 낚시대</p>
						            <p></p>
								</div>
					        </div>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="${pageContext.request.contextPath}/itemdetail.do?iidx=${itemVo.item_idx}&itemCode=1">상세보기</a></div>
                            </div>
                        </div>
                    </div>
                    </c:forEach>
						...
						<c:choose>
							<c:when test="${i==scri.page}">
								<li class="page-item active">
									<a class="page-link" href="${pageContext.request.contextPath}/shopculture.do?page=${i}&searchType=${pm.scri.searchType}&keyword=${pm.scri.keyword}">${i}</a>
								</li>
							</c:when>
							<c:otherwise>
								<li class="page-item">
