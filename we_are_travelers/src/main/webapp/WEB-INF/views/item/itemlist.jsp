					...
					<div class="col-lg-8 col-md-8 col-10" style="float: none; margin:0 auto;">
						<div class="main-menu-search">
							<div class="navbar-search search-style-5">
								...
								&nbsp
								&nbsp
								<a href="#" style="height: 40;"><img class="img-icon" src="${pageContext.request.contextPath}/resources/img/icon/icon_person.png" alt="..." /></a>
								&nbsp
								&nbsp
								<a href="#" style="height: 40;"><img class="img-icon" src="${pageContext.request.contextPath}/resources/img/icon/icon_cart.png" alt="..." /></a>
							</div>
						</div>
					</div>
