			...
			<div id="myCarousel" class="carousel slide" data-bs-ride="carousel" style="margin-top: 126px;">
		    	...
		    	<div class="carousel-inner">
					<div class="carousel-item active">
				      	<img class="bd-placeholder-img" style="width:100vw; height:300px;" src="${pageContext.request.contextPath}/resources/img/shoptitle/fishing2.png" aria-hidden="true"></img>
					        <div class="container">
								<div class="carousel-caption text-start">
									<h1 style="text-shadow:5px 5px 5px #000;">낚시인들을 위한 상품</h1>
								</div>
					        </div>
					</div>
					<div class="carousel-item">
						<img class="bd-placeholder-img" style="width:100vw; height:300px;" src="${pageContext.request.contextPath}/resources/img/shoptitle/fishing3.png" aria-hidden="true"></img>
						<div class="container">
					...
					<div class="carousel-item">
						<img class="bd-placeholder-img" style="width:100vw; height:300px;" src="${pageContext.request.contextPath}/resources/img/shoptitle/fishing1.png" aria-hidden="true"></img>
						<div class="container">
						...
						<c:choose>
							<c:when test="${i==scri.page}">
								<li class="page-item active">
									<a class="page-link" href="${pageContext.request.contextPath}/shopfishing.do?page=${i}&searchType=${pm.scri.searchType}&keyword=${pm.scri.keyword}">${i}</a>
								</li>
							</c:when>
							<c:otherwise>
								<li class="page-item">
