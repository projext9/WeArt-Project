...
<form name="join_form_info" id="join_com_finish" method="post" action="${pageContext.request.contextPath}/joinCompanyProcess.do">
...
<input type="hidden" name="company_buis_address" value="${company_buis_address }">
