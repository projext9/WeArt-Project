...
<h3>제 1 조 (목적)</h3>
<p>본 약관은 위아트팀이 운영하는 웹 사이트 (http://www.wearetravelers.com)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.</p>

<h3>제 2 조 (용어의 정의)</h3>
<p>본 약관에서 사용하는 용어는 다음과 같이 정의한다.</p>
<p><strong>①회원</strong> : 기본 회원 정보를 입력하였고, 회사와 서비스 이용계약을 체결하여 아이디를 부여받은 개인</p>
<p><strong>②아이디(E-MAIL)</strong> : 회원식별과 회원의 서비스 이용을 위해 회원이 선정하고 회사가 인증한 이메일</p>
<p><strong>③비밀번호(Password)</strong> : 회원이 통신상의 자신의 비밀을 보호하기 위해 선정한 문자와 숫자의 조합</p>
<p><strong>④해지</strong> : 회사 또는 회원에 의한 이용계약의 종료</p>
...
<br>
<br>
<hr style="border-box:none; border-bottom:2px solid #828282">
<h1>제 2 장 이용계약</h1>
<br>
<h3>제 5 조 (이용신청)</h3>
...
<p>③회사는 아래 사항에 해당하는 경우에 승낙을 하지 않을 수 있다.
...
<p>②회사는 이용자로부터 제기되는 의견이나 불만이 정당하다고 인정될 경우에는 즉시 처리해야 한다. 단, 즉시 처리가 곤란한 경우에는 이용자에게 그 사유와 처리일정을 공지사항 또는 전자우편을 통해 통보해야 한다.</p>
<p>③제1항의 경우 수사상의 목적으로 관계기관 및 정보통신윤리위원회의 요청이 있거나 영장 제시가 있는 경우, 기타 관계 법령에 의한 경우는 예외로 한다.</p>

<h3>제 8 조 (이용자의 의무)</h3>
<p>①이용자는 본 약관 및 회사의 공지사항, 사이트 이용안내 등을 숙지하고 준수해야 하며 기타 회사의 업무에 방해되는 행위를 해서는 안된다.</p>
<p>②이용자는 회사의 사전 승인 없이 본 사이트를 이용해 어떠한 영리행위도 할 수 없다.</p>
<p>③이용자는 본 사이트를 통해 얻는 정보를 회사의 사전 승낙 없이 복사, 복제, 변경, 번역, 출판, 방송 및 기타의 방법으로 사용하거나 이를 타인에게 제공할 수 없다.</p>
...
제 12 조 (서비스 이용의 제한)
<p><strong>본 사이트 이용 및 행위가 다음 각 항에 해당하는 경우 회사는 해당 이용자의 이용을 제한할 수 있다.</strong></p>
...
<p>⑧기타 관계 법령에 위배되는 경우 및 회사가 이용자로서 부적당하다고 판단한 경우</p>

제 13 조 (서비스 제공의 중지)
<p><strong>회사는 다음 각 호에 해당하는 경우 서비스의 전부 또는 일부의 제공을 중지할 수 있다.</strong></p>
