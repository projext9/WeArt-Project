...
<body>
	<main>
		<form method="post" action="${pageContext.request.contextPath}/add_reply.do?board_originidx=${boardVo.board_idx}" enctype="multipart/form-data" style="margin:5% 20% 5% 20%;">
