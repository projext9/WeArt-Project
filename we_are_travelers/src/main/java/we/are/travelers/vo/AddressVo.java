...
public class AddressVo {
	...
	public String getAddress_delyn() {
		return address_delyn;
	}
	public void setAddress_delyn(String address_delyn) {
		this.address_delyn = address_delyn;
	}
