...
public class SnsLoginService {
	...
	private final static String REDIRECT_URI = "http://192.168.0.170:8080/travelers/callBack";	    
	...
	public String getAccessTokenK (String authorize_code) {
		...
		try {
			...
			sb.append("&redirect_uri=http://192.168.0.170:8080/travelers/kakaoLogin.do"); // 본인이 설정한 주소
