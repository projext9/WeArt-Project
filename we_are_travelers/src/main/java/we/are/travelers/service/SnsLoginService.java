...
public class SnsLoginService {
	...
	private final static String REDIRECT_URI = "http://210.114.12.97/travelers/callBack";	    
	...
	public String getAccessTokenK (String authorize_code) {
		...
		try {
			...
			sb.append("&redirect_uri=http://210.114.12.97/travelers/kakaoLogin.do"); // 본인이 설정한 주소
